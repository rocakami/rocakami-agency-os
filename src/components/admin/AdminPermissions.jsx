            ...
            <Card className="border-0 shadow-sm">
              <CardContent className="p-5">
                <div className="flex items-center justify-between mb-4">
                 ...
                 <div className={`flex items-center justify-between px-4 py-3 rounded-lg border mb-3 ${selectedUser.role === "admin" ? "bg-navy-50 border-navy-200" : "bg-muted/40 border-border"}`}>
                   <div className="flex items-center gap-3">
                     <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${selectedUser.role === "admin" ? "bg-navy-600" : "bg-muted"}`}>
                       <Crown className={`w-4 h-4 ${selectedUser.role === "admin" ? "text-white" : "text-muted-foreground"}`} />
                     </div>
                     <div>
                   ...
                   <Switch checked={selectedUser.role === "admin"} onCheckedChange={() => toggleAdmin(selectedUser)} disabled={saving} />
                 </div>
